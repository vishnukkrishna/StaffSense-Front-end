...
function AdminChat(props) {
  ...
  const setUpChat = () => {
    axios
      .get(
        `${BACKEND_BASE_URL}/chat/user-previous-chats/${senderid}/${recipientid}/`
      )
      .then((response) => {
    ...
    const client = new W3CWebSocket(
      `${wsApiUrl}/ws/chat/${senderid}/?${recipientid}`
    );
        ...
        <div className="w-full">
          ...
          <div className="flex items-center justify-between w-full p-4 border-t border-gray-300 mt-12">
            ...
            <button type="submit" onClick={(e) => onButtonClicked()}>
              <svg
                className="w-8 h-8 text-customColor origin-center transform rotate-90"

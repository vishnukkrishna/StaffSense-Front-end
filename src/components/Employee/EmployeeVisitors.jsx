...
function EmployeeVisitors() {
    ...
    const currentVisitor = filteredVisitors.slice(indexOfFirstComplaint, indexOfLastComplaint);
            ...
            <div className="flex justify-end items-center mt-4 mr-64">
                <nav aria-label="Page navigation">
                    <ul className="inline-flex">
                        ...
                        {Array.from({ length: Math.ceil(filteredVisitors.length / ComplaintPerPage) }).map(
                            (item, index) => (
                                <li key={index}>
                                    <button
